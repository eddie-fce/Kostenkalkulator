...
- **Stammdaten**
  ...
  - Beliebig viele Filamente (Material + Farbe + Preis pro kg) – die Materialauswahl umfasst ~66 Sorten in 9 Gruppen (PLA, PETG, ABS/ASA, PC, PA/Nylon, PET, TPU/TPE, Support, Spezial), übersichtlich als Dropdown-Kategorien
  - Verschleißklassen A–F: fester Wartungssatz (€/Druckstunde) je Klasse, deckt Nozzle, Druckplatte, Hotend, Schläuche etc. ab – jedes Material im Filamentkatalog ist einer Klasse zugeordnet, deren Satz vollständig in die Kalkulation einfließt
...
- **Filamentkatalog-Tab**: eigener Reiter mit allen ~66 Materialien, gruppiert nach Familie und aufklappbar (Vorlage/Richtwerte – frei änderbar). Je Material: Verschleißklasse (A–F), Abrasiv (Ja/Nein), gehärtete Düse erforderlich, AMS geeignet (Ja/eingeschränkt/Nein), P1S geeignet (Freitext, z. B. „Ja, mit gehärteter Düse“ oder „nur nach Prüfung“), Trocknung erforderlich und ein Freitextfeld für besondere Hinweise
